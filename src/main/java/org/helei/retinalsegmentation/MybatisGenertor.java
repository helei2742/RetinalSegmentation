        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/Retinal_Segmentation?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false",
                ...
                .globalConfig(builder -> {
                    builder.author("helei") // 设置作者
                            ...
                            .outputDir("D:\\ideaworkspace\\retinalsegmentation\\retinalsegmentation\\src\\main\\java\\org\\helei\\retinalsegmentation"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                                    "D:\\ideaworkspace\\retinalsegmentation\\retinalsegmentation\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("tb_diagnostic_record") // 设置需要生成的表名
